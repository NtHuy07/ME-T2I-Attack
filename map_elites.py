...
class MAPElitesBase:
    ...
    def random_selection(self, num_random):
        ...
        return self.genomes[rand_id], self.fitnesses[rand_id], self.pheno[rand_id]
    ...
    def plot_fitness(self, step: int):
        ...
        if len(self.map_dims) > 1:
            ...
            plt.xlabel("Number of changes from Spacing mutation")
            plt.ylabel("Number of changes from Homoglyph mutation")
